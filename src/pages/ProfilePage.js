    ...
    <div>
      ...
      <CardContainer isLoading={isLoading}>
        {profileDishes.map((dish) => (
          <DishCard dish={dish} onClick={showModalHandler} />
        ))}
      </CardContainer>
    </div>
  );
